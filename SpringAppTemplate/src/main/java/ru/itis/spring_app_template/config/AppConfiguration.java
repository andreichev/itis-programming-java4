package ru.itis.spring_app_template.config;
...
@EnableWebMvc
@ComponentScan("ru.itis.spring_app_template")
@PropertySource("classpath:application.properties")
@EnableJpaRepositories("ru.itis.spring_app_template.repository")
...
public class AppConfiguration implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(JpaVendorAdapter adapter,
        ...
        entityManagerFactory.setPackagesToScan("ru.itis.spring_app_template.model");
